                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    @if($ses=="déconecter")
                                                              return    <li><a href="#signin-modal" data-toggle="modal">Sign in / Sign up</a></li>

                                    @else
                                        return             <form action="{{ route('user.logout') }}"  method="POST">
    @csrf
    <button type="submit" class="btn btn-dange">Déconnecter</button>
</form>                                   </form>
                                        @endif
                                </ul>
                            </li>
